...
- Suprisingly populat: <https://en.wikipedia.org/wiki/Surprisingly_populars>
- Multi arm bandit: <https://en.wikipedia.org/wiki/Multi-armed_bandit>
- Bayesian nework: <https://en.wikipedia.org/wiki/Bayesian_network>
...
- Trivial objection: <https://en.wikipedia.org/wiki/Trivial_objections>
...
- Survivorship bias: <https://en.wikipedia.org/wiki/Survivorship_biasv
...
- Winner's curse: <https://en.wikipedia.org/wiki/Winner>
- Regression Towards the Mean: <https://en.wikipedia.org/wiki/Regression_toward_the_mean>
...
vConventional wisdom: <https://en.wikipedia.org/wiki/Conventional_wisdom>
...
- Evidence (law): <https://en.wikipedia.org/wiki/Obliteration_by_incorporation>
...
- Ring (mathematics): <https://en.wikipedia.org/wiki/Ring_%28mathematics%29s>
- Power law: <https://en.wikipedia.org/wiki/Power_law>
- Coilgun: <https://en.wikipedia.org/wiki/Coilgun>
- Replication Crisis: <https://en.wikipedia.org/wiki/Replication_crisis>
- Falifiability: <https://en.wikipedia.org/wiki/Falsifiability>
...
- Scoring rule#Logarithmic_scoring_rule: <https://en.wikipedia.org/wiki/Scoring_rule#Logarithmic_scoring_rule>
